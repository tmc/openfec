...
type Candidate struct {
	ActiveThrough          float64     `json:"active_through,omitempty"`
	...
	ElectionYears          []float64   `json:"election_years,omitempty"`
	IncumbentChallenge     interface{} `json:"incumbent_challenge,omitempty"`
...
func (c *Client) GetCandidates() ([]*Candidate, error) {
	...
	return candidates, json.Unmarshal([]byte(result.Results), &candidates)
}
